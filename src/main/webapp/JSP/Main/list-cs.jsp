  ...
  <div id="wrap">
    ...
    <main id="container" class="sub_container list_page">
      <section class="contets">
        <div class="inner">
          <div class="m_wrap">
            <p><a href="index.html">HOME</a><span></span>고객센터</p>
          </div>
      ...
      <section class="ban_box">
        <div class="inner">
          <ul class="etc">
            <li>
              <a href="#"><p>1:1 상담하기</p></a>
            </li>
            <li>
              <a href="#"><p>전화 문의하기<span></span>TEL : 02-1234-5678 (매주 월-금 09:00 ~ 18:00)</p></a>
            </li>
          </ul>
        </div>
      </section>
